...
/*	public @ResponseBody UserBean updateUsersID(@PathVariable("id") long userId, @RequestBody UserBean user) {
		return this.userService.updateUser(userId, user);
	}*/
	
//	@RequestMapping(value = "**/userRP/{id}", method = RequestMethod.PUT, produces="application/json")
	/*	public @ResponseBody UserBean updateUserRP(@PathVariable("id") long userId, @RequestParam("password") String userPassword) {
		return this.userService.updateUser(userId, userPassword);
	}*/
